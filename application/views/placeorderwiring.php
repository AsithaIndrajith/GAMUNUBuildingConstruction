...
<html lang="en">
<head>
	<title>Place House Wiring Order</title>
	<meta charset="UTF-8">
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post" action="submitorder">
                ...
                <div hidden>
					<input value="765" class="input100" type="text" name="cus_service_id" hidden>
				</div>
				...
				<div class="wrap-input100 input100-select bg1">
					...
					<input class="input100" type="text" name="cus_service_type" value="House Wiring" readonly>
