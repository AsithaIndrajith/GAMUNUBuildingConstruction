...
<html lang="en">
<head>
	<title>Place Building Drawing Order</title>
	<meta charset="UTF-8">
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post" action="submitorder">
				<span class="contact100-form-title">
					Place an Building Drawing Order
				</span>
                ...
                <div hidden>
					<input value="554" class="input100" type="text" name="cus_service_id" hidden>
				</div>
				...
				<div class="wrap-input100 input100-select bg1">
					...
					<input class="input100" type="text" name="cus_service_type" value="Building Drawing" readonly>
                    
				</div>
                
                <div class="wrap-input100 input100-select bg1">
					<span class="label-input100">Service Price</span>
					<input class="input100" type="text" name="cus_price" value="From Rs. 4000/= Onwards" readonly>
