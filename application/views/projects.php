...
<body class="animsition">
    <div class="page-wrapper">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <h2 class="title-1 m-b-25">Projects Ongoing
                                </h2>
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            ...
                                            foreach($records as $row){
                                                $state;
                                                if($row['project_status']=="not complete"){
                                                    $state="warning";
                                                }else if($row['project_status']=="started"){
                                                    $state="primary";
                                                ...
                                                echo "<tr>
                                                        ...
                                                        <td>".$row['customer_name']."</td>    <td><p class='btn btn-".$state."'>".$row['project_status']."</p></td>
                                                        <td class='text-right'>".$row['start_date']."</td>
                                                        <td class='text-right'>".$row['end_date']."</td>
                                                        <td>Rs. ".$row['project_cost']." </td>
                                                        <td>".$row['worker_count']."</td>
                                                        <td><button data-target='#".$row['project_id']."' data-toggle='modal' type='submit' class='btn btn-warning'>Update</button>&nbsp<a  href='startProject/".$row['project_id']."'><button type='submit' class='btn btn-primary'>Start</button></a>&nbsp<a href='completeProject/".$row['project_id']."'><button type='submit' class='btn btn-success'>Complete</button></a></td>
                                                    </tr>";
                                            }                                        
                                            ?>
        ...
        <?php
            foreach($records as $row){
                echo "<div class='modal fade' id=".$row['project_id']." role='dialog'>
                <div class='modal-dialog'>
                  <div class='modal-content'>
                    <div class='modal-header'>
                        <button type='button' class='close' data-dismiss='modal'><font style='font-family:arial'></font></button>
                    ...
                    <div class='modal-body'>
                        <div style='text-align:center'>
                            <img src='../../public/img/img-items/product-img/project.png' style='border-radius:20px;width:40%'>
                        </div>
                        <!--login form-->
                        <form action='updateProjects' autocomplete='on' method='post'>
                            <div class='form-group'>
                                Project ID
                                <input style='border-radius:20px' type='text' class='form-control' value=".$row['project_id']." name='project_id' required readonly>
                            </div>
                            <div class='form-group'>
                                Project Name
                                <input style='border-radius:20px' type='text' class='form-control' value=".$row['project_name']." name='project_name' required>
                            </div>
                            <div class='form-group'>
                                Project Location
                                <input style='border-radius:20px' type='text' class='form-control' value=".$row['project_loc']." name='project_loc' required>
                            </div>
                            <div class='form-group'>
                                Project Cost Rs.
                                <input style='border-radius:20px' type='text' class='form-control' value=".$row['project_cost']." name='project_cost' required>
                            </div>
                            
                            <div class='form-group'>
                                Project Worker Count
                                <input style='border-radius:20px' type='text' class='form-control' value=".$row['worker_count']." name='worker_count' required>
                            </div>
