...
<body class="animsition">
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="overview-item overview-item--c4">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2><?=($totalEarnings->result_array())[0]['totalEarning']?></h2>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <h2 class="title-1 m-b-25">Services Offered 
                                     <button data-target='#addService' data-toggle='modal' class="btn btn-primary">
                                        <i class="zmdi zmdi-plus"></i>Add Service</button>
                                </h2>
                                        ...
                                        <tbody>
                                            ...
                                            foreach($records as $row){
                                                echo "<tr>
                                                        ...
                                                        <td><img src='".$row['service_image']."' style='width:80%;border-radius:20px'></td>
                                                        <td class='text-right'>".$row['price']."</td>
                                                        <td><a href='#' data-target='#".$row['service_id']."' data-toggle='modal'><button type='submit' class='btn btn-warning'>update</button></a>&nbsp<a href='removeService/".$row['service_id']."'><button class='btn btn-danger'>Remove</button></a></td>
                                                    </tr>";
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="addServices" autocomplete="on" method="post">
                            <div class="form-group">
                                Service ID
                                <input style="border-radius:20px" type="text" class="form-control" placeholder="Enter service id" name="service_id" required>
                            </div>
                            <div class="form-group">
                                Service Type
                                <input style="border-radius:20px" type="text" class="form-control" placeholder="Enter service type" name="service_type" required>
                            </div>

                            <div class="form-group">
                                Service Name
                                <input style="border-radius:20px" type="text" class="form-control" placeholder="Enter service name" name="service_name" required>
                            </div>

                            <div class="form-group">
                                Service Price
                                <input style="border-radius:20px" type="text" class="form-control" placeholder="Enter service price" name="service_price" required>
                            </div>
    ...
    <!--end sign in modal-->
        ...
        <?php
            foreach($records as $row){
                echo "<div class='modal fade' id=".$row['service_id']." role='dialog'>
                <div class='modal-dialog'>
                  <div class='modal-content'>
                    <div class='modal-header'>
                        <button type='button' class='close' data-dismiss='modal'><font style='font-family:arial'></font></button>
                    ...
                    <div class='modal-body'>
                        <div style='text-align:center'>
                            <img src='../../public/img/img-items/product-img/add-service.png' style='border-radius:20px;width:40%'>
                        </div>
                        <!--login form-->
                        <form action='updateServices' autocomplete='on' method='post'>
                            <div class='form-group'>
                                Service ID
                                <input style='border-radius:20px' type='text' class='form-control' value=".$row['service_id']." name='service_id' required readonly>
                            </div>
                            <div class='form-group'>
                                Service Type
                                <input style='border-radius:20px' type='text' class='form-control' value=".$row['service_type']." name='service_type' required>
                            </div>
                            <div class='form-group'>
                                Service Name
                                <input style='border-radius:20px' type='text' class='form-control' value=".$row['service_name']." name='service_name' required>
                            </div>
                            <div class='form-group'>
                                Service Price
                                <input style='border-radius:20px' type='text' class='form-control' value=".$row['price']." name='price' required>
                            </div>
