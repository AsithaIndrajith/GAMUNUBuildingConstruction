...
<html lang="en">
<head>
	<title>Place Painting Order</title>
	<meta charset="UTF-8">
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post" action="submitorder">
				<span class="contact100-form-title">
					Place an Construction Painting Order
				</span>
                ...
                <div hidden>
					<input value="402" class="input100" type="text" name="cus_service_id" hidden>
				</div>
				...
				<div class="wrap-input100 input100-select bg1">
					...
					<input class="input100" type="text" name="cus_service_type" value="Construction Painting" readonly>
