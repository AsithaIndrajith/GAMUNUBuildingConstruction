...
<html lang="en">
<head>
	<title>Place Tile Layering Order</title>
	<meta charset="UTF-8">
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post" action="submitorder">
                ...
                <div hidden>
					<input value="663" class="input100" type="text" name="cus_service_id" hidden>
				</div>
				...
				<div class="wrap-input100 input100-select bg1">
					...
					<input class="input100" type="text" name="cus_service_type" value="Tile Layering" readonly>
                    
				</div>
                <div class="wrap-input100 input100-select bg1">
					<span class="label-input100">Design Code</span>
                    
					<input class="input100" type="text" name="tileType" value="Optional">
                ...
                <div class="wrap-input100 input100-select bg1">
					...
					<input class="input100" type="text" name="cus_price" value="Negotiable" readonly>
